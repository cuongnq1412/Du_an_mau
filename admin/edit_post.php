    ...
    <form method="POST">
        ...
        <label for="title">Tiêu đề:<br>
            <input type="text" id="title" name="title" value="<?php echo $post['title']; ?>" class="addcmt"
                required></label>
        <label for="description">Mieu ta:<br>
            <textarea id="description" name="description" class="addcmt"
                required><?php echo $post['description']; ?></textarea></label>
        <label for="content">Nội dung:<br>
            <textarea id="editor" name="content" class="addcmt"><?php echo $post['content']; ?></textarea></label>
